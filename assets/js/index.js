!(function (n) {
  ...
  let o = 0;
  $("body").append(
    `<div id="fui-toast"></div><div class="td-lock-screen"><section class="td-welcome"><div class="medias"><video class="pc item_video" autoplay loop muted playsinline><source src="https://quyetdz210.x10.mx/assets/video/pc.mp4?v=${c()}" type="video/mp4"></video><video class="mobile item_video" autoplay loop muted playsinline><source src="https://quyetdz210.x10.mx/assets/video/mb.mp4?v=${c()}" type="video/mp4"></video><div class="date"></div></div><div class="infos"><div class="logo-web-title"><img class="logo-ws" src="./assets/img/anhnho.png" alt="Nguyễn Phú Quyết"><span class="web-title">${$("html").attr("data-title-loader") || "M\xe0n H\xecnh Kho\xe1"}</span></div><span class="web_desc"></span><span class="web_desc1"></span><div><i class="ri-arrow-down-line close-lockscreen"></i></div></div></section></div>`,
  );
  ...
  $(window).on("load", () => {
    ...
    console.log(
      "%c My Github %c https://github.com/nguyenphuquyet",
  ...
  (sakura = "https://i.imgur.com/erBwjHj.png"),
    (leaf = "https://i.imgur.com/erBwjHj.png"),
    (maple = "https://i.imgur.com/erBwjHj.png"),
    (user = ""),
    (T.src = maple),
...
let b1 = new (class n1 {
  constructor(n) {
    this.descriptions = n; // Danh sách mô tả
    this.element = $(".web_desc1"); // Phần tử đích
    this.Description(); // Khởi chạy ngay khi tạo lớp
  }
  Description() {
...
// Cập nhật nội dung động mỗi 1 giây
setInterval(() => b1.Description(), 1400);
